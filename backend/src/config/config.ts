...
const config: Config = {
  ...
  mongoUri: process.env.MONGODB_URI || 'mongodb+srv://ssholdings:D3MIteSgAONU5vk0@ssholdings.9aizwu5.mongodb.net/ssholdings?retryWrites=true&w=majority&ssl=true&authSource=admin',
